...
//
//
//        //TODO - Going to have to rework this entire thing if the URL processor doesn't work out.
//        //I can set the URL to day to get the correct results back from facets, then explode that back to "Fake" the
//        // month and year facet
//        // URL -- http://sector.ddev.local:8080/search?query=News&f%5B1%5D=issue_date%3A2016-08-05
//        // Works. Then I can explode on - to get 2016 and 08
//        // new facet('2016 using the exploded values. Should work and is probably cleaner really....?')
//
//
//
//        //kint($facet);
