...
namespace Drupal\facet_granular_date\Plugin\facets\query_type;
 ...
 *   label = @Translation("Date - Granular"),
 * )
 */
class SearchApiDateGranular extends QueryTypeRangeBase {
    ...
    public function __construct(array $configuration, $plugin_id, $plugin_definition) {
        ...
        $dateProcessorConfig = $processors['date_granular_item']->getConfiguration();
